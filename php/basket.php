      ...
      <div class="basket__block">
         <div class="basket__header">
            <div class="basket__count">
               <h1 class="basket__count--title">
                  Ваш кошик
               </h1>
               <div class="basket__count--number">(<span id="basketCountIn"></span>)</div>
            </div>
            <div class="basket__cross _basketTogle">
               <span></span>
            </div>
         </div>
      </div>
      <div class="basket__block">
         <div id="resultBasket" class="basket__body basket__slim">
         </div>
      </div>
      <div class="basket__block">
