...
<body>
   <div class="login">
      ...
      <div style="display:none" class="add__popap">
         <div class="add__title">товар додано!</div>
         <button class="login__btn add__btn add__btn--newColor popapBtn popapNew" onclick="popapClickAdminAdd()">додати ще один товар</button>
         <button class="login__btn add__btn popapBtn popapChoose" onclick="popapClickAdminAdd()">назад до сторінки вибору</button>
      </div>
      <?php
      }else{
